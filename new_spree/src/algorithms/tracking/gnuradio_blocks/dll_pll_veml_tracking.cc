...
void dll_pll_veml_tracking::start_tracking()
{
    ...
    LOG(WARNING) << "Tracking: " << d_acquisition_gnss_synchro->Channel_ID << " PRN: " << d_acquisition_gnss_synchro->PRN << " Doppler: " << d_acq_carrier_doppler_hz << " Code delay: " << d_acq_code_phase_samples;
