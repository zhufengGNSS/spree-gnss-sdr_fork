                                ...
                                out_streams_(out_streams)
{
    ...
    acquisition_ = pcps_make_sd_acquisition(acq_parameters_);
...
void GpsL1CaPcpsSdAcquisition::stop_acquisition()
{
}
...
void GpsL1CaPcpsSdAcquisition::set_state(int state)
{
...
void GpsL1CaPcpsSdAcquisition::set_resampler_latency(uint32_t latency_samples)
{
