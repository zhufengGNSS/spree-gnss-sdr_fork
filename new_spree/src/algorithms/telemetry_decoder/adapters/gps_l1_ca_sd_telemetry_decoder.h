...
#ifndef GNSS_SDR_GPS_L1_CA_SD_TELEMETRY_DECODER_H_
 ...
 */
class GpsL1CaSdTelemetryDecoder : public TelemetryDecoderInterface
{
public:
    ...
    //! Returns "GPS_L1_CA_SD_Telemetry_Decoder"
    ...
    inline void set_channel(int32_t channel) { telemetry_decoder_->set_channel(channel); }
...
private:
    gps_l1_ca_sd_telemetry_decoder_gs_sptr telemetry_decoder_;
