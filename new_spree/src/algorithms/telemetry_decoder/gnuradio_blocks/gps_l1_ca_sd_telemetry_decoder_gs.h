/*!
 * \file gps_l1_ca_sd_telemetry_decoder_gs.h
...
#ifndef GNSS_SDR_GPS_L1_CA_SD_TELEMETRY_DECODER_GS_H
#define GNSS_SDR_GPS_L1_CA_SD_TELEMETRY_DECODER_GS_H
...
class gps_l1_ca_sd_telemetry_decoder_gs;

using gps_l1_ca_sd_telemetry_decoder_gs_sptr = boost::shared_ptr<gps_l1_ca_sd_telemetry_decoder_gs>;
...
class gps_l1_ca_sd_telemetry_decoder_gs : public gr::block
{
public:
    ~gps_l1_ca_sd_telemetry_decoder_gs();
