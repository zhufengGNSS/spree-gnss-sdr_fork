    ...
    unsigned int out_streams, const gr::msg_queue::sptr queue)  // NOLINT(performance-unnecessary-value-param)
{
    ...
    // GPS L1 CA Acquisition block with spoofing detection
    else if (implementation == "GPS_L1_CA_PCPS_SD_Acquisition")
        {
    ...
    else if (implementation == "GPS_L1_CA_SD_Telemetry_Decoder")
        {
    ...
    // PVT -------------------------------------------------------------------------
    else if ((implementation == "RTKLIB_PVT") || (implementation == "GPS_L1_CA_SD_PVT") || (implementation == "GPS_L1_CA_PVT") || (implementation == "Galileo_E1_PVT") || (implementation == "Hybrid_PVT"))
        {
    ...
    unsigned int out_streams)
{
    ...
    // GPS L1 CA Telemetry decoder with spoofing detection
    else if (implementation == "GPS_L1_CA_SD_Telemetry_Decoder")
        {
