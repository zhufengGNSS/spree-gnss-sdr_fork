...
void gps_l1_ca_sd_telemetry_decoder_cc::forecast (int noutput_items, gr_vector_int &ninput_items_required)
{
...
int gps_l1_ca_sd_telemetry_decoder_cc::general_work (int noutput_items, gr_vector_int &ninput_items,
    ...
    if (d_symbol_accumulator_counter == 20)
        {
            ...
            //******* bits to words ******
            d_frame_bit_index++;
            if (d_frame_bit_index == 30)    //received one word
                {
                    d_frame_bit_index = 0;
                    // parity check
