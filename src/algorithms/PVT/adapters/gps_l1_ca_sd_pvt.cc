                ...
                out_streams_(out_streams)
{
    ...
    // make PVT object
    pvt_ = gps_l1_ca_make_sd_pvt_cc(in_streams_,
            dump_,
            dump_filename_,
            averaging_depth,
            flag_averaging,
...
bool GpsL1CaSdPvt::save_assistance_to_XML()
{
...
void GpsL1CaSdPvt::set_channels(std::vector<std::shared_ptr<ChannelInterface>> channels_)
{
    pvt_->set_channels(channels_);
}
