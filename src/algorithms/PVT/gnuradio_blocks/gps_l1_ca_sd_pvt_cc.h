...
#ifndef GNSS_SDR_GPS_L1_CA_SD_PVT_CC_H
#define GNSS_SDR_GPS_L1_CA_SD_PVT_CC_H
...
class gps_l1_ca_sd_pvt_cc;

typedef boost::shared_ptr<gps_l1_ca_sd_pvt_cc> gps_l1_ca_sd_pvt_cc_sptr;

gps_l1_ca_sd_pvt_cc_sptr gps_l1_ca_make_sd_pvt_cc(unsigned int n_channels,
                                            bool dump,
 ...
 */
class gps_l1_ca_sd_pvt_cc : public gr::block
{
private:
    friend gps_l1_ca_sd_pvt_cc_sptr gps_l1_ca_make_sd_pvt_cc(unsigned int nchannels,
                                                       bool dump,
                                                       std::string dump_filename,
                                                       int averaging_depth,
                                                       bool flag_averaging,
    ...
    std::vector<std::shared_ptr<ChannelInterface>> d_channels;
