...
#ifndef GNSS_SDR_PCPS_SD_ACQUISITION_CC_H_
...
typedef boost::shared_ptr<pcps_sd_acquisition_cc> pcps_sd_acquisition_cc_sptr;

pcps_sd_acquisition_cc_sptr
 ...
 */
class pcps_sd_acquisition_cc: public gr::block
{
private:
    friend pcps_sd_acquisition_cc_sptr
    pcps_make_sd_acquisition_cc(unsigned int sampled_ms, unsigned int max_dwells,
            unsigned int doppler_max, long freq, long fs_in,
            int samples_per_ms, int samples_per_code,
            bool bit_transition_flag,
...
#endif /* GNSS_SDR_PCPS_SD_ACQUISITION_CC_H_*/
